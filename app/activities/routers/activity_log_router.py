...
activity_log_crud = CRUDBase[Activity_logs, schema.ActivityLogCreate, schema.ActivityLogUpdate](
...
async def create_activity_log(activity_log: schema.ActivityLogCreate, db: db_dependency):
...
async def update_activity_log(request: Request, activity_log: schema.ActivityLogUpdate, db: db_dependency):
    filters = activity_log_crud.require_filters(build_filters(Activity_logs, request.query_params))
